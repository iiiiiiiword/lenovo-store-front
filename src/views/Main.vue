<template>
  <body>
    ...
    <Finish></Finish>
    <Down></Down>
    <for-show :OnlySeeMoreDiaVisible.sync="OnlySeeMoreDiaVisible"
              :idToShow="idToShow">
    </for-show>
...
import ForShow from "@/component/ForShow";
...
export default {
  ...
  methods: {
    ...
    seeMore(index, row) {
      ...
      this.OnlySeeMoreDiaVisible = true
    },
    showJudge(index ,row){
      this.idToShow = row.computerId
